...
### Se você quiser entrar em contato, você pode:

<table style="margin: 0 auto;">
  <tr>
    <td style="vertical-align: middle; text-align: center;">
      Acessar meu Facebook clicando na imagem ao lado
    </td>
    <td>
      [![Acessar meu Facebok clicando na imagem ao lado](https://upload.wikimedia.org/wikipedia/commons/thumb/c/cd/Facebook_logo_%28square%29.png/640px-Facebook_logo_%28square%29.png){width=50px}](https://www.facebook.com/idonotreallyknow?locale=pt_BR)
    </td>
  </tr>
</table>
...
<table style="margin: 0 auto;">
  <tr>
    ...
    <td>
      [![Acessar meu Facebok clicando na imagem ao lado](https://upload.wikimedia.org/wikipedia/commons/5/58/Instagram-Icon.png){width=50px}](https://www.instagram.com/imsherwaldorf/)
    </td>
  </tr>
</table>
...
<div style="text-align: center; margin-top: 20px;">
  <p>Clique na imagem para copiar meu endereço de e-mail.</p>
</div>
...
<body>
  ...
  <!-- Imagem que, ao clicar, copia o email -->
  <img src="https://logodownload.org/wp-content/uploads/2018/03/gmail-logo-16.png" alt="Clique aqui para copiar o e-mail" onclick="copyEmail()" style="cursor: pointer; width: 50px; height: 50px;">
  
  <!-- Campo de texto oculto que contém o email -->
  <input type="text" value="sher.off@gmail.com" id="emailInput" style="position: absolute; left: -9999px;">
  ...
  <script>
    function copyEmail() {
      ...
      // Opcional: Alerta ou feedback ao usuário
      alert("O e-mail foi copiado para a área de transferência!");
    }
  </script>
