...
<div style="text-align: center; margin-top: 20px;">
  <h1>Sheron Magalhães dos Santos</h1>
</div>


> Graduada em Licencaiatura em Matemática - FURG

> Mestranda em Ambientometria - FURG

> Graduanda em Medicina Veterinária - FURG

<p style="text-align: center; font-size: 20px;">
  Veja abaixo o cronograma previsto de atividades que exerço atualmente:
</p>
...
<style>
  ...
  th, td {
    ...
    text-align: center;
    padding: 8px;
    background-color: #f0f0f0; /* Cinza fraco para todas as células */
    color: black; /* Cor da fonte em preto */
  }
  .Livre {
    background-color: lightgreen; /* Cor de fundo verde claro para células com a classe Livre */
  }
</style>
...
<table>
  ...
  <tr>
    <td>8h-8h50</td>
    <td>Histologia I - UFPEL</td>
    <td class="Livre">Livre</td>
    <td class="Livre">Livre</td>
    <td>Anatomia I - UFPEL</td>
    <td class="Livre">Livre</td>
  </tr>
  <tr>
    <td>8h50-9h40</td>
