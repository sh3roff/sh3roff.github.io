...
<div style="text-align: center; margin-top: 20px;">
  <h1>Cetacean Statistcs</h1>
  <p>Entenda nesse site a temática de pesquisa que estou elaborando.</p>
</div>


<div style="text-align: center; margin-top: 20px;">
  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTsUk_VLsw9gA7uJ87iyEByWJsaU9ixhe_fvw&s" alt="Descrição da Imagem" style="max-width: 100%; height: auto;">
</div>

Os cetáceos são uma subordem de animais que vivem predominantemente em ambientes marinhos e são mamíferos. O nome "cetáceo" deriva do grego ketos, que significa monstro marinho. Os cetáceos estão divididos em duas ordens: animais com dentes e animais sem dentes.

Clique [aqui](apresentacao.html) para visualizar a apresentação que elaborei!

Clique [aqui](testrticles/testrticles.pdf) para visualizar um modelo de artigo em pdf que criei utilizando a biblioteca rticles.


<a href="página1.html" class="btn btn-warning">Sobre a autora</a>
<a href="pagina2.html" class="btn btn-primary">Tema de pesquisa</a>
<a href="pagina3.html"class="btn btn-light">Estatísticas</a>
<a href="pagina4.html" class="btn btn-info">Entre em contato</a>
<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
  <button type="button" class="btn btn-success">Links externos</button>
  ...
  <a class="dropdown-item" href="https://www.furg.br/">FURG</a>
  <a class="dropdown-item" href="https://ppgambientometria.furg.br/">PPGAmb</a>
  </div>
  </div>
</div>
